...
\begin{figure} [H]
	\centering  
	\frame{\includegraphics[scale=0.5]{memasukanBentrok.png}}
...
\begin{figure} [H]
	\centering  
	\frame{\includegraphics[scale=0.5]{GagalMasuk.png}}
...
\end{figure}
	...
	\begin{figure} [H]
	\centering  
	\frame{\includegraphics[scale=0.5]{daftarJadwal.png}}
